    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_user', models.CharField(choices=[('economico', 'Económico'), ('jefe_area', 'Jefe de Área'), ('admin_sitio', 'Administrador del sitio')], max_length=11)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
                ('area', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='inventario.area')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('aceptada', 'Aceptada'), ('en_espera', 'En espera'), ('denegada', 'Denegada')])),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventario.producto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('en_uso', 'En uso'), ('almacen', 'Almacen'), ('en_reparacion', 'En reparación'), ('dado_de_baja', 'Dado de baja')], max_length=30)),
                ('observaciones', models.TextField(blank=True, null=True)),
                ('producto', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='inventario.producto')),
                ('ubicacion', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='inventario.ubicacion')),
            ],
            options={
